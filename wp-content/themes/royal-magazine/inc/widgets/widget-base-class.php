		...
		switch ( $field_type ) {
			...
			case 'image':
				...
				<div>
					...
					?>
					<input type="button" value="<?php echo _x( 'X', 'Remove', 'royal-magazine' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
